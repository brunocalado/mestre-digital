...
new Dialog({
  ...
  content: `
    <style>
      ...
      #swade-template-creator form {
        margin-bottom: 20px;
      }
      #swade-template-creator .form-fields.buttons {
        justify-content: flex-start !important;
      }
      #swade-template-creator .button {
        flex: 1 !important;
        border-width: 9px;        
        font-size: 12px;
        padding: 0;
      ...
      #swade-template-creator .button:hover {
        box-shadow: 0 0 8px white;
      }
      #swade-template-creator .radios input[type="radio"] {
        opacity: 0;
        position: fixed;
        width: 0;
      }
      #swade-template-creator .radios label {
        cursor: pointer;
        display: flex;
        flex: 1 !important;
        margin: -2px 0;
      ...
      #swade-template-creator .radios label i {
        margin-right: 5px;
        color: #ffefbd;
        background: #171f69;
      }
      #swade-template-creator .radios label:hover {
        box-shadow: 0 0 8px white;
      }
      #swade-template-creator .radios input[type="radio"]:checked + label {
        background: rgba(255, 0, 0, 0.4);        
      }
      #swade-template-creator .dialog-button {
        height: 50px;
        background: #171f69;        
        color: #ffefbd;
        border-width: 9px;
    ...
    <form>
      <div class="form-group">        
        <div class="form-fields buttons radios">
          ...
          <label for="emanation" onclick="toggleEmanationMessage(true)"><i class="fas fa-wifi"></i> Cone</label>
          <input type="radio" name="shape" id="burst" value="burst">
          <label for="burst" onclick="toggleEmanationMessage(false)"><i class="fas fa-circle"></i> Small</label>
          <input type="radio" name="shape" id="cone" value="cone">
          <label for="cone" onclick="toggleEmanationMessage(false)"><i class="fas fa-circle"></i> Medium</label>
          <input type="radio" name="shape" id="line" value="line">
          <label for="line" onclick="toggleEmanationMessage(false)"><i class="fas fa-circle"></i> Large</label>
        </div>
      </div>
    </form>
